...
def connect_to_server(host='127.0.0.1',port=8888, name=""): #Accept custom IP and Port or default to IP 127.0.0.1 and port 8888
    global client_socket
    client_socket = socket.socket(socket.AF_INET, socket.SOCK_STREAM) #Create a dictionary set of socket data using the socket library
